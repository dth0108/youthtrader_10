  ...
  private async initializeRestaurants() {
    ...
    const sampleRestaurants: InsertRestaurant[] = [
      ...
      },
      {
        ...
        rating: "4.6",
        reviewCount: "203",
        description: "전통 한정식을 현대적으로 해석한 요리들이 정갈하게 나옵니다. 한국 문화를 느낄 수 있어요.",
        distance: "도보 7분",
        placeId: "jongno_restaurant_1",
      },
      {
        name: "명동 이자카야",
        location: "myeongdong",
        ...
        rating: "4.2",
        reviewCount: "94",
        description: "다양한 일본식 안주와 사케를 즐길 수 있습니다. 분위기가 아늑하고 좋아요.",
        distance: "도보 6분",
        placeId: "myeongdong_restaurant_1",
      },
      {
        name: "한강 치킨 맛집",
        location: "hangang",
  ...
  async getSurveyStats() {
    ...
    responses.forEach(response => {
      ...
      response.timePreferences.forEach(timePreference => {
        ...
        timeStats[timePreference.time].priority += (5 - timePreference.priority); // Higher priority = higher score
      });
    });
